    ...
    <div className="App">
     ...
     <h1>Our Projects</h1>
      ...
      <div className="maincontainer">
          <Card img={cardsname[0].img} name={cardsname[0].name}/>    
          <Card img={cardsname[1].img} name={cardsname[1].name}/>    
          <Card img={cardsname[2].img} name={cardsname[2].name}/>    
          <Card img={cardsname[3].img} name={cardsname[3].name}/>    
          <Card img={cardsname[4].img} name={cardsname[4].name}/>    
          <Card img={cardsname[5].img} name={cardsname[5].name}/>    
          <Card img={cardsname[6].img} name={cardsname[6].name}/>    
          <Card img={cardsname[7].img} name={cardsname[7].name}/>    
          <Card img={cardsname[8].img} name={cardsname[8].name}/>    
          <Card img={cardsname[9].img} name={cardsname[9].name}/>    
          <Card img={cardsname[10].img} name={cardsname[10].name}/>    
          <Card img={cardsname[11].img} name={cardsname[11].name}/>    
      </div>
      <Footer  />
